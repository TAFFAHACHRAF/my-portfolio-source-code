...
import java1 from "../../Assets/Projects/java-1.png";
import drupal1 from "../../Assets/Projects/drupal-1.png";
import node1 from "../../Assets/Projects/nodeJs-1.png";
import node2 from "../../Assets/Projects/nodeJs-2.png";
import node3 from "../../Assets/Projects/nodeJs-3.png";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/TAFFAHACHRAF/Tasks-management-project"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/TAFFAHACHRAF/taffah-projet-web"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="The objective of this project is the realization of a full stack web application in the form of a reservation system for commercial consultations, and a directory of product source links, simple and easy to use, which firstly contains a public interface which presents the GUIDE DERB OMAR companies, and allowing sales companies to create an account with a type of subscription to be determined."
              ghLink="https://github.com/TAFFAHACHRAF/Guide-Derb-Omar-App"
              demoLink="hhttps://github.com/TAFFAHACHRAF/Guide-Derb-Omar-App"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/TAFFAHACHRAF/my-portfolio-taffah"
              demoLink="https://github.com/TAFFAHACHRAF/my-portfolio-taffah"
            />
          </Col>
